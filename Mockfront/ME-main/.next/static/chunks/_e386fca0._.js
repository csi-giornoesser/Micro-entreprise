...
"[project]/app/(crm)/crm/exports/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ExportsAdminPage() {
    ...
    const [operators, setOperators] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    // États pour les formulaires d'export
    const [dossiersForm, setDossiersForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        status: "all",
        partnerId: "all",
        operatorId: "all",
        dateFrom: "",
    ...
    const [commissionsForm, setCommissionsForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        partnerId: "all",
        dateFrom: "",
        dateTo: "",
        groupBy: "dossier" // "dossier" | "partner" | "month"
    });
    const [activityForm, setActivityForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
    ...
    async function exportDossiers() {
        ...
        qs.set("format", "csv");
        downloadFile("/api/exports/dossiers?".concat(qs.toString()), "dossiers_".concat(new Date().toISOString().slice(0, 10), ".csv"));
    }
    async function exportCommissions() {
        ...
        qs.set("format", "csv");
        downloadFile("/api/exports/commissions?".concat(qs.toString()), "commissions_".concat(commissionsForm.groupBy, "_").concat(new Date().toISOString().slice(0, 10), ".csv"));
    }
    async function exportActivity() {
        ...
        qs.set("format", "csv");
        downloadFile("/api/exports/activite?".concat(qs.toString()), "rapport_activite_".concat(activityForm.type, "_").concat(new Date().toISOString().slice(0, 10), ".csv"));
    }
...
_s(ExportsAdminPage, "6QJWo86Eo8xJHmGlXkPd2UWCgiw=");
_c = ExportsAdminPage;
var _c;
__turbopack_context__.k.register(_c, "ExportsAdminPage");
...
//# sourceMappingURL=_e386fca0._.js.map