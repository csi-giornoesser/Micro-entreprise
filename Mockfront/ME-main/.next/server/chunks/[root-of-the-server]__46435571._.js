...
"[project]/app/api/dossiers/[id]/messages/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const GET = (req, { params })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$_lib$2f$proxy$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["proxyRequest"])(req, `/api/dossiers/${params.id}/messages`);
const POST = (req, { params })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$_lib$2f$proxy$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["proxyRequest"])(req, `/api/dossiers/${params.id}/messages`);
}),

};

//# sourceMappingURL=%5Broot-of-the-server%5D__46435571._.js.map